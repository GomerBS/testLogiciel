...
final class SnapshotRepository
{
    ...
    public function get(): array
    {
        ...
        $snapshot = str_replace(dirname($this->testsPath) . 'SnapshotRepository.php/', '', $snapshotFilename);
    ...
    public function save(string $snapshot): string
    {
        ...
        return str_replace(dirname($this->testsPath) . 'SnapshotRepository.php/', '', $snapshotFilename);
    }
