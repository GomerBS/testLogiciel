<div class="exception">
  ...
  <div class="exc-message">
    ...
    <ul class="search-for-help">
      ...
      <?php endif ?>
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://google.com/search?q=<?php echo urlencode(implode('\\', $name) . ' header.html.php' .$message) ?>" title="Search for help on Google.">
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://duckduckgo.com/?q=<?php echo urlencode(implode('\\', $name) . ' header.html.php' .$message) ?>" title="Search for help on DuckDuckGo.">
      ...
      <li>
        <a rel="noopener noreferrer" target="_blank" href="https://stackoverflow.com/search?q=<?php echo urlencode(implode('\\', $name) . ' header.html.php' .$message) ?>" title="Search for help on Stack Overflow.">
